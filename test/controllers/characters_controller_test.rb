...
class CharactersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update character" do
    patch character_url(@character), params: { character: { attack_point: @character.attack_point, defence_point: @character.defence_point, life_point: @character.life_point, name: @character.name } }
